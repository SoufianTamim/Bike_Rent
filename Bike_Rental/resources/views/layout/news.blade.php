        ...
        <div class="news-cover row">
            <div class="col-12 col-md-6 col-lg-4">
                <div class="news-item">
                    ...
                    <div class="news-post-thumbnail">
                        <a href="news.html"><img class="rx-lazy" src="../img/placeholder-all.png" data-src="../img/news-1.jpg" alt="news"></a>
                    </div>
                    <div class="meta">
            ...
            <div class="col-12 col-md-6 col-lg-4">
                <div class="news-item">
                    ...
                    <div class="news-post-thumbnail">
                        <a href="single-news.html"><img class="rx-lazy" src="../img/placeholder-all.png" data-src="../img/news-2.jpg" alt="news"></a>
                    </div>
                    <div class="meta">
                        <span class="date"><i class="fa fa-calendar" aria-hidden="true"></i> Dec 26,2019</span>
                        <span class="post-by"><i class="fa fa-user" aria-hidden="true"></i> By <a href="#">Samson</a></span>
            ...
            <div class="col-12 col-md-6 col-lg-4">
                <div class="news-item">
                    ...
                    <div class="news-post-thumbnail">
                        <a href="news.html"><img class="rx-lazy" src="../img/placeholder-all.png" data-src="../img/news-3.jpg" alt="news"></a>
                    </div>
                    <div class="meta">
                        <span class="date"><i class="fa fa-calendar" aria-hidden="true"></i> Dec 26,2019</span>
                        <span class="post-by"><i class="fa fa-user" aria-hidden="true"></i> By <a href="#">Samson</a></span>
