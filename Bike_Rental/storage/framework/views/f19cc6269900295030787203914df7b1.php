...
<body id="home">
    ...
    <!-- =================== HEADER =================== -->
        ...
        <div class="header-menu">
            <div class="container">
                <a href="<?php echo e(route('index')); ?>" class="logo"><img src="../img/favicon.png" alt="logo"></a>
                <nav class="nav-menu">
                    <ul class="nav-list">
                        <li class="active"><a href="<?php echo e(route('index')); ?>">Home</a></li>
                        <li><a href="<?php echo e(route('bikes')); ?>">bikes</a></li>
    ...
    <!-- =================== HEADER END =================== -->
<?php /**PATH C:\Users\soufian tamim\Desktop\Bike_Rent\Bike_Rental\resources\views/layout/header.blade.php ENDPATH**/ ?>