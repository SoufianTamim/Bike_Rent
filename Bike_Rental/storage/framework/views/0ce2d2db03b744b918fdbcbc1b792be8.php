			...
			<div class="row">
				<div class="col-12 col-lg-8 blog-cover">
					<div class="post-item-cover">
						<h4 class="title title-line-left"><a href="<?php echo e(route('snews')); ?>">Lorem ipsum dolor sit amet, consectetur</a></h4>
						<div class="post-header">
							<div class="post-thumbnail">
								<a href="<?php echo e(route('snews')); ?>">
						...
						<div class="post-footer">
							...
							<a href="<?php echo e(route('snews')); ?>" class="btn"><span>more</span></a>
						</div>
					</div>
					<div class="post-item-cover">
						<h4 class="title title-line-left"><a href="<?php echo e(route('snews')); ?>">Duis aute irure dolor in reprehenderit in</a></h4>
						<div class="post-header">
							<div class="post-thumbnail">
								<a href="<?php echo e(route('snews')); ?>">
					...
					<div class="post-item-cover">
						<div class="post-header">
							<h4 class="title title-line-left"><a href="<?php echo e(route('snews')); ?>">sed do eiusmod tempor incididunt ut labore et</a></h4>
							<div class="meta">
								<span class="post-date"><i class="fa fa-calendar" aria-hidden="true"></i>Dec 26, 2019</span>
								<span class="post-by"><i class="fa fa-user" aria-hidden="true"></i>By <a href="#">Samson</a></span>
								<span class="post-category">Category: <a href="#">Coaching</a><a href="#">Lorem</a></span>
				...
				<div class="col-12 col-lg-4 sidebar">
					...
					<ul class="widgets">
						...
						<li class="widget widget-instagram">
							...
							<ul>
								<li>
									<a href="#"><img src="../img/insta-widget-1.jpg" alt="img"></a>
								</li>
								<li>
									<a href="#"><img src="../img/insta-widget-2.jpg" alt="img"></a>
								</li>
								<li>
									<a href="#"><img src="../img/insta-widget-3.jpg" alt="img"></a>
								</li>
								<li>
									<a href="#"><img src="../img/insta-widget-4.jpg" alt="img"></a>
								</li>
								<li>
									<a href="#"><img src="../img/insta-widget-5.jpg" alt="img"></a>
								</li>
								<li>
									<a href="#"><img src="../img/insta-widget-6.jpg" alt="img"></a>
								</li>
							</ul>
						</li>
	...
	<!--=================== S-NEWS END ===================-->
<?php /**PATH C:\Users\soufian tamim\Desktop\Bike_Rent\Bike_Rental\resources\views/layout/news_sec.blade.php ENDPATH**/ ?>