    ...
    <div class="container">
        <form class="find-bike-form">
            ...
            <ul class="form-wrap">
                ...
                <li><a href="<?php echo e(route('bikes')); ?>" class="btn"><span>search</span></a></li>
            </ul>
        </form>
    </div>
</section>
<!--============== S-FIND-BIKE END ==============--><?php /**PATH C:\Users\soufian tamim\Desktop\Bike_Rent\Bike_Rental\resources\views/layout/filter.blade.php ENDPATH**/ ?>