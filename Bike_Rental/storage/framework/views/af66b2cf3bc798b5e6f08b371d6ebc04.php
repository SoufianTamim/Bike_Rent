            ...
            <div class="slide-categ-bicycle">
                <div class="categ-bicycle-item">
                    ...
                    <div class="categ-bicycle-info">
                        ...
                        <a href="<?php echo e(route('bikes')); ?>" class="btn"><span>view more</span></a>
                    </div>
                </div>
            </div>
            <div class="slide-categ-bicycle">
...
<!--============ S-CATEGORY-BICYKLE END ============--><?php /**PATH C:\Users\soufian tamim\Desktop\Bike_Rent\Bike_Rental\resources\views/layout/bike_parts.blade.php ENDPATH**/ ?>