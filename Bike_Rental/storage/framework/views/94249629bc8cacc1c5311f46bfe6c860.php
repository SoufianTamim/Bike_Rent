				...
				<div class="col-12 col-lg-9 shop-cover">
					<div class="baner-shop">
						...
						<div class="baner-item-content">
							...
							<a href="<?php echo e(route('sbike')); ?>" class="btn"><span>read more</span></a>
						...
						<div class="row product-cover block">
							<div class="col-12 col-sm-4 prod-item-col">
								<div class="product-item">
									...
									<a href="<?php echo e(route('sbike')); ?>" class="product-img"><img src="../img/prod-1.png" alt="product"></a>
									<div class="product-item-wrap">
										<div class="product-item-cover">
											...
											<h6 class="prod-title"><a href="<?php echo e(route('sbike')); ?>">Granite Peak 24" <br>Girls Mountain Bike</a></h6>
											<a href="<?php echo e(route('sbike')); ?>" class="btn"><span>RENT NOW</span></a>
										</div>
										<div class="prod-info">
											<ul class="prod-list">
							...
							<div class="col-12 col-sm-4 prod-item-col">
								<div class="product-item">
									...
									<a href="<?php echo e(route('sbike')); ?>" class="product-img"><img src="../img/prod-2.png" alt="product"></a>
									<div class="product-item-wrap">
										<div class="product-item-cover">
											<div class="price-cover">
												<div class="new-price">$1.699</div>
											</div>
											<h6 class="prod-title"><a href="<?php echo e(route('sbike')); ?>">Hyper E-Ride Bike 700C <br>20+ Mile Range</a></h6>
											<a href="<?php echo e(route('sbike')); ?>" class="btn"><span>RENT NOW</span></a>
										</div>
										<div class="prod-info">
											<ul class="prod-list">
							...
							<div class="col-12 col-sm-4 prod-item-col">
								<div class="product-item">
									...
									<a href="<?php echo e(route('sbike')); ?>" class="product-img"><img src="../img/prod-3.png" alt="product"></a>
									<div class="product-item-wrap">
										<div class="product-item-cover">
											<div class="price-cover">
												<div class="new-price">$1.699</div>
											...
											<h6 class="prod-title"><a href="<?php echo e(route('sbike')); ?>">Lightweight M370-27speed <br>Aluminum Alloy Mantis</a></h6>
											<a href="<?php echo e(route('sbike')); ?>" class="btn"><span>RENT NOW</span></a>
										</div>
										<div class="prod-info">
											<ul class="prod-list">
							...
							<div class="col-12 col-sm-4 prod-item-col">
								<div class="product-item">
									...
									<a href="<?php echo e(route('sbike')); ?>" class="product-img"><img src="../img/prod-4.png" alt="product"></a>
									<div class="product-item-wrap">
										<div class="product-item-cover">
											<div class="price-cover">
												<div class="new-price">$1.699</div>
											</div>
											<h6 class="prod-title"><a href="<?php echo e(route('sbike')); ?>">New Spring Beach Cruiser <br>Bicycle Chrome</a></h6>
											<a href="<?php echo e(route('sbike')); ?>" class="btn"><span>RENT NOW</span></a>
										</div>
										<div class="prod-info">
											<ul class="prod-list">
							...
							<div class="col-12 col-sm-4 prod-item-col">
								<div class="product-item">
									...
									<a href="<?php echo e(route('sbike')); ?>" class="product-img"><img src="../img/prod-5.png" alt="product"></a>
									<div class="product-item-wrap">
										<div class="product-item-cover">
											<div class="price-cover">
												<div class="new-price">$1.699</div>
							...
							<div class="col-12 col-sm-4 prod-item-col">
								<div class="product-item">
									...
									<a href="<?php echo e(route('sbike')); ?>" class="product-img"><img src="../img/prod-6.png" alt="product"></a>
									<div class="product-item-wrap">
										<div class="product-item-cover">
											<div class="price-cover">
												<div class="new-price">$1.699</div>
											</div>
											<h6 class="prod-title"><a href="<?php echo e(route('sbike')); ?>">Aluminum and Fork <br>Mountain Sr-26omg</a></h6>
											<a href="<?php echo e(route('sbike')); ?>" class="btn"><span>RENT NOW</span></a>
										</div>
										<div class="prod-info">
											<ul class="prod-list">
							...
							<div class="col-12 col-sm-4 prod-item-col">
								<div class="product-item">
									...
									<a href="<?php echo e(route('sbike')); ?>" class="product-img"><img src="../img/prod-7.png" alt="product"></a>
									<div class="product-item-wrap">
										<div class="product-item-cover">
											<div class="price-cover">
												<div class="new-price">$1.699</div>
											</div>
											<h6 class="prod-title"><a href="<?php echo e(route('sbike')); ?>">Steel Frame MTB Bike <br>with 21 Speed</a></h6>
											<a href="<?php echo e(route('sbike')); ?>" class="btn"><span>RENT NOW</span></a>
										</div>
										<div class="prod-info">
											<ul class="prod-list">
							...
							<div class="col-12 col-sm-4 prod-item-col">
								<div class="product-item">
									...
									<a href="<?php echo e(route('sbike')); ?>" class="product-img"><img src="../img/prod-8.png" alt="product"></a>
									<div class="product-item-wrap">
										<div class="product-item-cover">
											<div class="price-cover">
												<div class="new-price">$1.699</div>
											</div>
											<h6 class="prod-title"><a href="<?php echo e(route('sbike')); ?>">Leopard Rider No Chain <br>Mountain Bicycle</a></h6>
											<a href="<?php echo e(route('sbike')); ?>" class="btn"><span>RENT NOW</span></a>
										</div>
										<div class="prod-info">
											<ul class="prod-list">
	...
	<!--=================== BIKES END ===================--><?php /**PATH C:\Users\soufian tamim\Desktop\Bike_Rent\Bike_Rental\resources\views/layout/bikes_avai.blade.php ENDPATH**/ ?>