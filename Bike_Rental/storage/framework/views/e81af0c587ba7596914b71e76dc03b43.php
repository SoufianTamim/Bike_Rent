		...
		<div class="container">
			...
			<div class="our-advantages-wrap advantages-wrap-about">
				<div class="our-advantages-item">
					<img src="../img/advantages-about-1.svg" alt="icon">
					<h5>Electric <br> Bikes</h5>
				</div>
				<div class="our-advantages-item wow fadeInUp" data-wow-duration=".6s" data-wow-delay=".25s">
					<img src="../img/advantages-about-2.svg" alt="icon">
					<h5>Repairing service <br>for free</h5>
				</div>
				<div class="our-advantages-item wow fadeInUp" data-wow-duration=".6s" data-wow-delay=".35s">
					<img src="../img/advantages-about-3.svg" alt="icon">
					<h5>Low Coast  <br> plus than 4 days</h5>
				</div>
				<div class="our-advantages-item wow fadeInUp" data-wow-duration=".6s" data-wow-delay=".45s">
					<img src="../img/advantages-about-4.svg" alt="icon">
					<h5>Discounts for <br>customers</h5>
				</div>
			</div>
		</div>
	</section>
	<!-- ============ ABOUT-ADVANTAGES END ============ --><?php /**PATH C:\Users\soufian tamim\Desktop\Bike_Rent\Bike_Rental\resources\views/layout/about_advan.blade.php ENDPATH**/ ?>