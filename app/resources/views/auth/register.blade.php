<x-guest-layout>
    <form method="POST" action="{{ route('register') }}" class="container" enctype="multipart/form-data">
        ...
        <div class="flex-row">
            ...
            {{-- phone number --}}
            <div class="input-field ">
                <x-text-input id="phone" class="input" type="tel" name="phone" :value="old('phone')" required placeholder="Phone" />
        ...
        <div class="flex-row">
            ...
            {{-- birthdate --}}
            <div class="input-field ">
                <x-text-input id="birthdate" class="input" type="date" name="birthdate" :value="old('birthdate')" type="text" placeholder="Birth Date" onfocus="(this.type='date')" />
        ...
        <div class="flex items-center justify-end mt-4">
            <x-primary-button class="submit btn btn-login" >
                <span>
                    {{ __('Register') }}
                </span>
            </x-primary-button>
